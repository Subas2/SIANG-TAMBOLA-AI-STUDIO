-- Tambola Game - All-in-One Setup Script
...
CREATE TABLE settings (
    ...
    "isPlayerTicketRequestEnabled" BOOLEAN DEFAULT false,
    "isAgentBookingEnabled" BOOLEAN DEFAULT false,
    announcement JSONB,
    "activeThemeId" UUID,
...
-- 5. Initial Data
INSERT INTO users (id, name, username, role) VALUES ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Admin', 'admin', 'admin');
INSERT INTO themes (id, name) VALUES ('b2c3d4e5-f678-90ab-cdef-1234567890ab', 'Default');
INSERT INTO games (id, title, status) VALUES ('c3d4e5f6-7890-abcd-ef12-34567890abcd', 'Initial Tambola Game', 'upcoming');
INSERT INTO settings (id, "activeThemeId") VALUES ('d4e5f678-90ab-cdef-1234-567890abcdef', 'b2c3d4e5-f678-90ab-cdef-1234567890ab');
